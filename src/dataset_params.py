...
def get_model_params(datasets_path, dataset_name, model_type=None):
  ...
  if dataset_name =='carObj12' and model_type is None:
    model_type = 'cad'
...
def get_split_params(datasets_path, dataset_name, split, split_type=None):
  ...
  # car 
    ...
    if split == 'train':
      p['scene_ids'] = [1,2,3,4] # TODO car
    elif split == 'test':
      p['scene_ids'] = [1,2] # TODO car

  elif dataset_name == 'carObj12':
    if split == 'train':
      p['scene_ids'] = [1,2,3,4]  #list(range(1, 3)) # TODO car
    elif split == 'test':
      p['scene_ids'] = [1,2] #list(range(1, 21)) # TODO car
