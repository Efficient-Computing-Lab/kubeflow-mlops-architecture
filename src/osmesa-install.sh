...
if [ ! -f "mesa-${mesaversion}.tar.gz" ]; then
    ...
    echo "https://archive.mesa3d.org/older-versions/17.x/mesa-17.1.6.tar.gz"
    curl $curlopts -O "https://archive.mesa3d.org/older-versions/17.x/mesa-17.1.6.tar.gz" || curl $curlopts -O "https://archive.mesa3d.org/older-versions/17.x/mesa-17.1.6.tar.gz"
fi
